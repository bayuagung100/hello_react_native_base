...
import { Header, Title, Button, Text, Container, Accordion, Content, Badge, Card, CardItem, Left, Thumbnail, Body, Icon, Right, Footer, FooterTab, } from 'native-base';
    ...
    return (
      <Container>
        ...
        <ScrollView style={{marginTop:10}}>
          <Button><Text>Button Native Base</Text></Button>
          <Accordion
            dataArray={dataArray}
